...
return(
    ...
    <section className="w-full h-full flex flex-col gap-6 p-6 lg:px-32 lg:gap-20 bg-zinc-50">
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
            <div className="w-full min-h-96 bg-cover bg-[url('https://consulting.stylemixthemes.com/valencia/wp-content/uploads/sites/53/2021/08/building.jpeg')]"></div>
            ...
            <div className="w-full min-h-96 bg-blue-950 p-12 flex flex-col gap-6 text-white">
                ...
                <ul className="flex flex-col gap-4">
                    ...
                    <a href="mailto:brandon@consulting.com"className="text-wrap font-semibold text-wrap">brandon@consulting.com</a>
                    </li>
        ...
        <div className="grid grid-cols-1 gap-2 md:grid-cols-12">
            <div className="grid gap-2 md:col-span-8">
                ...
                <form className="grid grid-cols-1 md:grid-cols-2 gap-4 gap-y-6">
                    ...
                    <span className="w-full grid gap-y-6 col-span-1">
                        <textarea name="mesage" id="" className="w-full h-32 shadow-sm"></textarea>
